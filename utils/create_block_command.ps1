...
# Build the PowerShell one-liner that matches executor.lua's blocking_command
# This is the exact pattern from the lua code
$psOneLiner = @"
powershell -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "$('$')psi = New-Object System.Diagnostics.ProcessStartInfo; $('$')psi.FileName = \`"cmd.exe\`"; $('$')psi.Arguments = \`"/c cd $CommandDir ^&^& $Command ^&^& echo $SuccessDesignator ^|^| echo $FailureDesignator \`"; $('$')psi.RedirectStandardOutput = $('$')true; $('$')psi.RedirectStandardError = $('$')true; $('$')psi.UseShellExecute = $('$')false; $('$')psi.CreateNoWindow = $('$')true; $('$')process = [System.Diagnostics.Process]::Start($('$')psi); $('$')process.WaitForExit(); $('$')stdout = $('$')process.StandardOutput.ReadToEnd(); $('$')stderr = $('$')process.StandardError.ReadToEnd(); $('$')exitCode = $('$')process.ExitCode; Write-Host ''; Write-Host '============================================================================'; Write-Host 'RESULT'; Write-Host '============================================================================'; if ($('$')stdout -match '$SuccessDesignator') { Write-Host 'Status: SUCCESS' } else { Write-Host 'Status: FAILURE' }; Write-Host 'Exit Code:' $('$')exitCode; Write-Host ''; Write-Host '============================================================================'; Write-Host 'STDOUT'; Write-Host '============================================================================'; $('$')stdoutClean = $('$')stdout -replace '$SuccessDesignator', '' -replace '$FailureDesignator', ''; Write-Host $('$')stdoutClean; Write-Host ''; Write-Host '============================================================================'; Write-Host 'STDERR'; Write-Host '============================================================================'; Write-Host $('$')stderr; Write-Host ''"
"@
