...
REM
REM Usage: check_job.bat "job_uuid" [tail_lines]
REM   job_uuid   - required
REM   tail_lines - optional, number of lines to show from stdout/stderr (default 50)
REM Example:
REM   check_job.bat "78f734c4-496c-40d0-83f4-127d43e97195"
REM   check_job.bat "78f734c4-496c-40d0-83f4-127d43e97195" 200
REM ============================================================================
...
if "%~1"=="" (
    ...
    echo Usage: check_job.bat "job_uuid" [tail_lines]
    exit /b 1
)
